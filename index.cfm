...
<ul>
	...
	<li><a href="tojson.cfm?strictmapping=false">Serialize Complex Struct to JSON (just the populated fields)</a></li>
	...
	<li><a href="tonative.cfm?strictmapping=false">Serialize Complex Struct to native CF Struct (just the populated fields)</a></li>
</ul>
...
<ul>
	...
	<li><a href="tojson.cfm?strictmapping=false&populate=jsonminimum">Serialize Complex Struct to JSON (just the populated fields)</a></li>
	...
	<li><a href="tonative.cfm?strictmapping=false&populate=jsonminimum">Serialize Complex Struct to native CF Struct (just the populated fields)</a></li>
</ul>
...
<ul>
	...
	<li><a href="tojson.cfm?strictmapping=false&populate=query">Serialize Complex Struct to JSON (just the populated fields)</a></li>
	...
	<li><a href="tonative.cfm?strictmapping=false&populate=query">Serialize Complex Struct to native CF Struct (just the populated fields)</a></li>
</ul>