...
<ul>
	...
	<li><a href="tojson.cfm?everything=false">Serialize Complex Struct to JSON (just the populate fields)</a></li>
	...
	<li><a href="tonative.cfm?everything=false">Serialize Complex Struct to native CF Struct (just the populate fields)</a></li>
</ul>
...
<ul>
	...
	<li><a href="tojson.cfm?everything=false&populate=json">Serialize Complex Struct to JSON (just the populate fields)</a></li>
	...
	<li><a href="tonative.cfm?everything=false&populate=json">Serialize Complex Struct to native CF Struct (just the populate fields)</a></li>
</ul>